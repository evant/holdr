...
import static me.tatarka.holdr.compile.SpecHelpers.*
...
class HoldrGeneratorSpec extends Specification {
    ...
    def "an empty list of views generates an empty Holdr"() {
        ...
        ASSERT.about(javaSource())
                .that(JavaFileObjects.forSourceString("me.tatarka.test.holdr.Holdr_Test",
                generator.generate(Layout.of(testPath()).build(), emptyIncludeResolver())))
                .parsesAs(JavaFileObjects.forSourceString("me.tatarka.test.holdr.Holdr_Test",
                """
...
public class Holdr_Test extends Holdr {
     ...
     *
     * @param view The root view to search for the holdr's views.
     */
    ...
    def "a single view generates a Holdr that instantiates that view"() {
        ...
        ASSERT.about(javaSource())
                .that(JavaFileObjects.forSourceString("me.tatarka.test.holdr.Holdr_Test",
                generator.generate(Layout.of(testPath())
...
public class Holdr_Test extends Holdr {
    ...
    def "a custom superclass generates a Holdr that subclasses that superclass"() {
        ...
        ASSERT.about(javaSource())
                .that(JavaFileObjects.forSourceString("me.tatarka.test.holdr.Holdr_Test",
                generator.generate(Layout.of(testPath()).superclass("test.TestHoldr").build(), emptyIncludeResolver())))
                .parsesAs(JavaFileObjects.forSourceString("me.tatarka.test.holdr.Holdr_Test",
                """
package me.tatarka.test.holdr;
...
public class Holdr_Test extends TestHoldr {
    public final static int LAYOUT = R.layout.test;

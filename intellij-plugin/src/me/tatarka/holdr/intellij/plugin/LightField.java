 ...
 * An implementation of PsiField that takes away most of the boilerplate.
 */
class LightField extends LightElement implements PsiField, PsiVariableEx, NavigationItem {
    ...
    public LightField(@NotNull String name,
